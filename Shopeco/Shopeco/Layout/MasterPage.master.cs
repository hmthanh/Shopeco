    ...
    { 
        ...
        if (Session["CurrentUser"] != null)
        {
            if (!String.IsNullOrEmpty(Session["CurrentUser"].ToString()))
            {
                ...
                //my_account.InnerHtml = "<a href='#' title='My Account ' class='btn-xs dropdown-toggle' data-toggle='dropdown'> <span class='hidden-xs' > <b>" + email + " </b></span></a>";
                string userName = StaticData.getField("tb_User", "FullName", "ID", idUser);
                if (String.IsNullOrEmpty(userName))
                {
                    userName = "Username";
                }
                accountControl.InnerHtml = "<a href='" + GetRouteUrl("user_info", new object { }) + "'><b> " + userName + "</b></a><a href='" + GetRouteUrl("logout", new { }) + "'><p>Đăng xuất</p></a>";
        ...
        if (!IsPostBack)
        {
            ...
            //LoadInfomation();
            //string thtml = "";
            //thtml += @"<li><p class='close-menu'></p>";
            //thtml +=  "<a href='"+GetRouteUrl("pages", new { id = 12})+"' class='clearfix'>";
            //thtml +=  "<img src='../images/HeThong/ThuongHieu.png'><strong>Thương hiệu</strong></a></li>";
            //thtml +=  "<li><p class='close-menu'></p>";
            //thtml +=  "     <a href='"+GetRouteUrl("pages", new { id = 11})+"' class='clearfix'>";
            //thtml +=  "         <img src='../images/HeThong/NapThe.png'><strong>Dịch vụ &amp; Nạp thẻ</strong></a></li>";
            //thtml +=  " <li>";
            //thtml +=  "     <p class='close-menu'></p>";
            //thtml +=  "     <a href='"+GetRouteUrl("pages", new { id = 10})+"' class='clearfix'>";
            //thtml +=  "         <img src='../images/HeThong/MaGiamGia.png'><strong>Mã giảm giá</strong></a></li>";
            //thtml +=  " <li>";
            //thtml +=  "     <p class='close-menu'></p>";
            //thtml +=  "     <a href='"+GetRouteUrl("new", new { nameEn = "tin-tuc", id = 5})+"' class='clearfix'>";
            //thtml +=  "         <img src='../images/HeThong/TinTuc.png'><strong>Tin tức</strong></a></li>";
            //thtml +=  " <li>";
            //thtml +=  "     <p class='close-menu'></p>";
            //thtml +=  "     <a href='"+GetRouteUrl("pages", new { id = 8})+"' class='clearfix'>";
            //thtml +=  "         <img src='../images/HeThong/HuongDan.png'><strong>Hướng dẫn</strong></a></li>";
            //thtml +=  " <li>";
            //thtml +=  "     <p class='close-menu'></p>";
            //thtml +=  "     <a href='"+GetRouteUrl("dangnhap_saleorder", new { })+"' class='clearfix'>";
            //thtml +=  "         <img src='../images/HeThong/KiemTra.png'><strong>Kiểm tra hàng</strong></a></li>'";
                    ...
                    html += @"
                                                    <tr>
                                                        <td class='text-center' style='width: 70px'>
                                                            <a href='" + link + @"'>";
                    html += @"                                   <img src='" + MyStaticData.LinkAnh(tb.Rows[0]["Anh"].ToString()) + @"' style='width: 70px' alt='Yutculpa ullamcon' title='Yutculpa ullamco' class='preview'>";
                    html += @"                              </a>
                                                        </td>
...
+ StaticData.getField("tb_Size", "Size", "idSize", cart.Rows[i]["idSize"].ToString()) + @" </a>
                ...
                html += @"    
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <p class='text-right'>
                                                    <a class='btn view-cart' href='/gio-hang'><i class='fa fa-shopping-cart'></i>Xem giỏ hàng</a>
                                                </p>
                                            </div>
                                        </li>
                                    </ul>";
    ...
    //            html += @"<li class='item-vertical with-sub-menu hover' " + ((i > 7) ? "style='display: none;'" : "") + "> <p class='close-menu'></p> "+
    //                            "<a href='" + link + "' class='clearfix'>" +
    //                            "<img  src='" + tb.Rows[i]["icon"] + "' alt='icon'/>" + "<span>" + tb.Rows[i]["TenLoaiSanPham"] + "</span>";
    ...
    //            html += "</li>";
    //        }
    //        html += "<li class='loadmore'><i class='fa fa-plus-square'></i><span class='more-view'>Mở thêm</span></li>";
    //        html += "</ul";
    //        html += "</div";
    //        html += "</div";
    ...
    private void LoadLoaiSanPham()
    {
        ...
        for (int i = 0; i < tb.Rows.Count; i++)
        {
            ...
            if (i > 7)
            {
                html += "<li class='item-vertical with-sub-menu hover' style='display:none;'>";
            }
            else
            {
            ...
            html += "        <i style='width: 13px;margin-top: -2px;' class='fa " + tb.Rows[i]["icon"] + @"'></i>";
