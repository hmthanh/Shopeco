...
public static class Connect
{
    public static SqlConnection ConnectSQL()
    {
        ...
        string s = @"Data Source=103.252.253.116, 1433;Initial Catalog=db_WebThuongMaiDienTu;User ID=login103; Password=103;Connect Timeout=10";
        //string s = @"Data Source=.;Initial Catalog=db_WebThuongMaiDienTu;Integrated Security=True";
        //Test
