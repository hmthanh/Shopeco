...
(--Convert delimited string to XML
 ...
 CROSS APPLY tempPlayer.nodes('/p/p') Members(Member)) as tb where idSize = m.idSize and idSanPham = '" + id + "') from tb_Size m where KichHoat = 1";
    ...
    protected void btLuu_Click(object sender, EventArgs e)
    {
        ...
        string idGianHang = StaticData.getField("tb_GianHang", "ID", "SoDienThoai", phone);
        ...
        if (id == "0" || id == "")
        {
            ...
            sqlInserNguoiDung += " values(N'" + MaSanPham + "',N'" + TenSanPham + "',N'" + GiaCu + "',N'" + GiaMoi + "','" + Mau + "','" + Size + "',N'" + MoTa + "',N'" + idLoaiSanPham + "','" + idThuongHieu + "','" + TrangChu + "','" + TinHOT + "','" + KichHoat + "', '" + idGianHang + "')";
        ...
        else
        {
            ...
            sqlUpdateNguoiDung += " ,idThuongHieu= N'" + idThuongHieu + "'";
