<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/DangNhap.master" CodeFile="Login.aspx.cs" Inherits="GianHang_Login" %>
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="100">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtEmail" type="text" placeholder="Email/Số điện thoại/Tên đăng nhập" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
