<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/GianHangLogin.master" CodeFile="Login.aspx.cs" Inherits="GianHangLogin_Login" %>
    ...
    <form runat="server" method="post">
        <div data-v-fe11aa12="" class="wrapper">
            <div data-v-fe11aa12="" class="account-container grid">
                ...
                <div data-v-fe11aa12="" class="login">
                            ...
                            <div data-v-44c03dd9="">
                                <div data-v-44c03dd9="" class="signin-title">
                                    <i data-v-44c03dd9="" class="Shopee-icon">
                                        <svg version="1.1" id="Layer1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="33 0 32 32" style="enable-background: new 33 0 32 32;" xml:space="preserve">
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="100">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtEmail" type="text" placeholder="Số điện thoại" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                        <p id="msgEmail" runat="server" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtPassword" type="password" placeholder="Mật khẩu" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                        <p id="msgPassword" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    <!---->
                                    <%--<div data-v-44c03dd9="" class="grid">
                                        ...
                                        <div data-v-44c03dd9="" class="forget col-8"><a data-v-44c03dd9="" href="<%=GetRouteUrl("gianhang_register",new { }) %>">Tạo tài khoản</a></div>
                                    </div>--%>
                                    <asp:Button ID="btDangNhap" runat="server" OnClick="btDangNhap_Click" data-v-44c03dd9="" class="Shopee-button Shopee-button--primary Shopee-button--block Shopee-button--round" Text="Đăng nhập">
                                    </asp:Button>
                                    <div class="row" style="text-align:center; margin: 0 auto;">
                                        Bạn chưa có tài khoản, hãy vào trang   <a href="<%=GetRouteUrl("gianhang_register",new { }) %>" style="margin-left:10px;">Đăng Ký</a>
                                    </div>
                                </div>
                            </div>
                        </div>
