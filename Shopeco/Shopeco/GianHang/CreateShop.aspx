<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/MainBoard.master" CodeFile="CreateShop.aspx.cs" Inherits="GianHang_ShopInfoEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainboard" runat="Server">
            ...
            <div id="ember4669" class="shop-setting-header ember-view">
                <div class="shop-setting-header__content">
                    ...
                    <div class="shop-setting-header__caption ">
                        ...
                        <div class="shop-setting-header__subtitle">Cập nhật những thông tin sau để tạo gian hàng .</div>
                    </div>
                        ...
                        <div class="edit-row">
                            ...
                            <div class="edit-input">
                                <div id="ember4813432" class="shopee-textbox ember-view">
                                    ...
                                    <div class="input">
                                        <asp:TextBox type="text" placeholder="Tên gian hàng" maxlength="80" id="tenGianHang" class="ember-text-field ember-view" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edit-row">
                            <div class="edit-input">
                                <div id="ember42212" class="shopee-textbox ember-view">
                                    <asp:DropDownList ID="slTinh" CssClass="custom-select ember-text-field ember-view" runat="server" OnSelectedIndexChanged="slTinh_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="edit-row">
                            <div class="edit-input">
                                <div id="ember212" class="shopee-textbox ember-view">
                                    <asp:DropDownList  id="slHuyen" class="custom-select ember-text-field ember-view" runat="server" AutoPostBack="true" OnSelectedIndexChanged="slHuyen_SelectedIndexChanged" >
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edit-row">
                            <div class="edit-input">
                                <div id="ember4142" class="shopee-textbox ember-view">
                                    <div class="shopee-validation-toast"></div>
                                    <div class="input">
                                        <asp:TextBox type="text" placeholder="Số nhà, đường ... " maxlength="80" id="diachiGianHang" class="ember-text-field ember-view" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            function updateAddress() {
                ...
                var addr = address[0] + ', ' + xa + ', ' + huyen + ', ' + tinh;
    ...
    <script>
        ...
        //    if (name == "" || owner == "" || phone == "" || description == "")
        //    {
        ...
        //        data: { name: name, address: address, description: description, owner: owner, phone: phone },
