<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/GianHangLogin.master" CodeFile="Register.aspx.cs" Inherits="GianHang_Default" %>
                ...
                <div data-v-fe11aa12="" class="col-8">
                    <div data-v-fe11aa12="" class="text">
                        ...
                        <div data-v-fe11aa12="" class="subtitle">
                            Quản lý shop của bạn một cách hiệu quả hơn trên Shopeco - Kênh Người bán
                            ...
                            <div data-v-44c03dd9="">
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div class="row" style="text-align:center; margin: 0 auto;">
                                        Bạn đã có tài khoản, hãy vào trang   <a href="<%=GetRouteUrl("gianhang_login",new { }) %>" style="margin-left:10px;">Đăng Nhập</a>
                                    </div>
                                </div>
                            </div>
                        </div>
