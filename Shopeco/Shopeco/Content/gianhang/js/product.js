...
//    $('#ember7034').addClass('active');
//}

if (Params.has('active')) {
    $('.tabs__tab').removeClass('active');
    $('#ember7035').addClass('active');
}

if (Params.has('soldout')) {
    $('.tabs__tab').removeClass('active');
    $('#ember7036').addClass('active');
}

if (Params.has('banned')) {
    $('.tabs__tab').removeClass('active');
    $('#ember7037').addClass('active');
}

if (!Params.has('active') && !Params.has('soldout') && !Params.has('banned')) {
    $('.tabs__tab').removeClass('active');
    $('#ember7034').addClass('active');
}
