        ...
        <div id="content">
                ...
                <div class="slider-container row"> 
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col2">
                        <div class="module sohomepage-slider ">
                            <div class="yt-content-slider" id="dvBanner" runat="server" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column00="1" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                                
                                <div class="yt-content-slide">
                                    <a href="#"><img src="/Content/UI/image/catalog/slideshow/home1/slider-2.jpg" alt="slider2" class="img-responsive"></a>
                                </div>
                                <div class="yt-content-slide">
                                    <a href="#"><img src="/Content/UI/image/catalog/slideshow/home1/slider-3.jpg" alt="slider3" class="img-responsive"></a>
                                </div>
                            </div>
            ...
            <div class="row content-main-w">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 main-left">
                    ...
                    <div class="panel_r resize_hidden">
                        <div class="contac_qc">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                 ...
                 <%--   <div id="so_category_slider_1" class="so-category-slider container-slider module cateslider1">
                    ...
                    <div id="so_category_slider_3" class="so-category-slider container-slider module cateslider1">
                        <div class="modcontent">
                            ...
                            <div class="categoryslider-content">
                                ...
                                <div class="slider category-slider-inner products-list yt-content-slider" id="dvSanPhamBanChay" runat="server" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="5" data-speed="0.6" data-margin="30" data-items_column00="5" data-items_column0="5" data-items_column1="2" data-items_column2="1" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="so_category_slider_2" class="so-category-slider container-slider module cateslider2">
                        <div class="modcontent">
                            <div class="page-top">
                                <div class="page-title-categoryslider">Bách hóa online</div>
                                <%-- <div class="item-sub-cat">
                                <ul>
                            ...
                            <div class="categoryslider-content">
                                <div class="slider category-slider-inner products-list yt-content-slider" id="dvPhuKienDa" runat="server" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column00="4" data-items_column0="4" data-items_column1="2" data-items_column2="1" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                                </div>
                            </div>
                        </div>
                    </div>
