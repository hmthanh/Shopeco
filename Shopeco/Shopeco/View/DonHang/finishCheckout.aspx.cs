...
public partial class View_DonHang_finishCheckout : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        subtitle.InnerHtml = "Đơn hàng " + order_code + " đã xử lý thành công<br/> Tổng cộng : <span style='color:red;' >" + price + "</span> vnđ <br/> <small>Trình duyệt sẽ tự chuyển trong 3s nữa</small>";
        //if (rs)
        //{
