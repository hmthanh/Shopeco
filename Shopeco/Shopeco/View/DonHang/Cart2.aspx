<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/MasterPage.master" CodeFile="Cart2.aspx.cs" Inherits="DonHang_Cart" %>
    ...
    <script>
        ...
        function DatHang() {
          ...
          //  if (ID != "")
            ...
            if ($("#ContentPlaceHolder1_txtHoTen").val() != "") {
                if ($("#ContentPlaceHolder1_txtSoDienThoai").val() != "") {
                    if ($("#ContentPlaceHolder1_txtDiaChi").val() != "") {
    ...
    <div class="main-container container">
        ...
        <div class="row">
            ...
            <div id="content" class="col-sm-12">
                ...
                <div class="panel-group" id="accordion">
                    <div style="margin: 0 30px;">
                        ...
                        <div class="div-input col-sm-6" >
                            <div class="div-left" style="margin: 0 30px;">
                            ...
                            <div class="div-right" style="margin: 0 30px;">
                ...
                <div class="buttons" style="padding-bottom: 20px; margin: 0 50px;">
