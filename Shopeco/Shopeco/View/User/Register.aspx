                        ...
                        <div data-v-44c03dd9="" class="signin">
                            <div data-v-44c03dd9="">
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div style="display: none;" data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtNguoiDaiDien" type="name" placeholder="Họ Tên đầy đủ" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtSoDienThoai" type="text" placeholder="Số điện thoại" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                        <p id="msgSoDienThoai" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtEmail" type="email" placeholder="Email" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                        <p id="msgEmail" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtTenDangNhap" type="text" placeholder="Địa Chỉ" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        ...
                                        <p id="msgMatKhau" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    ...
                                    <asp:Button ID="btDangKy" runat="server" OnClick="btDangKy_Click" data-v-44c03dd9="" class="Shopee-button Shopee-button--primary Shopee-button--block Shopee-button--round" Text="Đăng ký"></asp:Button>
                                    <div class="row" style="text-align: center; margin: 0 auto;">
                                        Bạn đã có tài khoản, hãy vào trang <a href="<%=GetRouteUrl("login",new { }) %>" style="margin-left: 10px;">Đăng nhập</a>
                                    </div>
