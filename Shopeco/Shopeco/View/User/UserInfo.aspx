<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/MasterPage.master" CodeFile="UserInfo.aspx.cs" Inherits="View_User_Login" %>
                    ...
                    <div class="">
                        <div id="ember6145" class="shop-setting-header ember-view">
                            <div class="shop-setting-header__content">
                                ...
                                <a href="<%=GetRouteUrl("user_editinfo", new object { })%>" id="btnAddProduct" class="shopee-button shopee-button--inactive shopee-button--primary ember-view">
                                    <svg viewBox="0 0 32 32">
                        ...
                        <div id="ember6146" class="setting-card__row setting-card__row--disabled ember-view">
                            ...
                            <div id="tenNguoiDung" class="setting-card__subtitle" runat="server"></div>
                        </div>
                        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
                            ...
                            <div id="diaChiEmail" class="setting-card__subtitle" runat="server"></div>
                        </div>
                        <%--<div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
                            <div class="setting-card__icon">
                                <svg viewBox="0 0 32 32">
                        ...
                        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
                            ...
                            <div id="diachi" class="setting-card__subtitle" runat="server"></div>
                        </div>
                    </div>
