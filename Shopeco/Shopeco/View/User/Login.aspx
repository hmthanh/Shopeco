                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="100">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtTenDangNhap" type="text" placeholder="Số Điện Thoại" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                    ...
                                    Bạn chưa có tài khoản, hãy vào trang   <a href="<%=GetRouteUrl("register",new { }) %>" style="margin-left: 10px;">Đăng Ký</a>
                                </div>
                                </div>
                            </div>
                        </div>
