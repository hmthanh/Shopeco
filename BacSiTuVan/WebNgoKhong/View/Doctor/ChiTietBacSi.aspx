<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="ChiTietBacSi.aspx.cs" Inherits="View_Home_Index" %>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="col-xs-12 col-sm-4">
                                        <figure id="docImg" runat="server">
                                            
                                        </figure>
                                    </div>
                                    <div class="col-xs-12 col-sm-8">
                                        <ul class="list-group">
                                            <li class="list-group-item"><i class="fa fa-user-md"></i>&nbsp;&nbsp;<span id="docName" runat="server"></span></li>
                                            <li class="list-group-item"><i class="fa fa fa-medkit"></i>&nbsp;&nbsp;<span id="docSpecialist" runat="server"></span></li>
                                            <li class="list-group-item"><i class="fa fa-stethoscope"></i>&nbsp;&nbsp;<span id="docWork" runat="server"> </span></li>
                                            <li class="list-group-item"><i class="fa fa-phone"></i>&nbsp;&nbsp;<span id="docPhone" runat="server"> .</span></li>
                                            <li class="list-group-item"><i class="fa fa-envelope"></i>&nbsp;&nbsp;<span id="docEmail" runat="server"> </span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bs-callout bs-callout-danger">
                            <h4><asp:Literal ID="Literal3" runat="server" Text="<%$Resources:name.language, descIntro%>" /></h4>
                            <p id="sumary" runat="server">
                                
                            </p>
                        </div>
                        <div class="bs-callout bs-callout-danger">
                            <h4><asp:Literal ID="Literal1" runat="server" Text="<%$Resources:name.language, descRegency%>" /></h4>
                            <div id="regency" runat="server">
                            </div>
                        </div>
                        <div class="bs-callout bs-callout-danger">
                            <h4><asp:Literal ID="Literal2" runat="server" Text="<%$Resources:name.language, descExperience%>" /></h4>
                        ...
                        <div class="bs-callout bs-callout-danger">
                            <h4><asp:Literal ID="Literal4" runat="server" Text="<%$Resources:name.language, descEducation%>" /></h4>
