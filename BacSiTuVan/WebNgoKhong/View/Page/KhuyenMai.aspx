<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/AdminMaster.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="KhuyenMai.aspx.cs" Inherits="View_Home_Index" %>
                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title">
                            ...
                            <h5><asp:Literal ID="Literal1" runat="server" Text="<%$Resources:name.language, headerEditPromotion %>" /></h5>
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: center;">
                                            <div class="container">
                                                ...
                                                <a id="btnBack" href="<%=GetRouteUrl("listpagepromotion", new {}) %>" class="btn btn-info"><asp:Literal ID="Literal5" runat="server" Text="<%$Resources:name.language, btnBack %>" /></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tfoot>
