<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="PageDetail.aspx.cs" Inherits="View_Home_GioiThieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Giới thiệu</a></div>
        </div>
