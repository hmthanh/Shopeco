<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/AdminMaster.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ThongBao.aspx.cs" Inherits="View_Home_Index" %>
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: center;">
                                            <div class="container">
                                                ...
                                                <a id="btnBack" href="<%=GetRouteUrl("listpagenotify", new {}) %>" class="btn btn-info"><asp:Literal ID="Literal5" runat="server" Text="<%$Resources:name.language, btnBack%>" /></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tfoot>
