<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="BoughtProcessing.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserBought&type=2&date=' + dateSearch,
    ...
    <div class="">
        ...
        <div class=" tab-action">
            <div class="tabs">
                ...
                <a href="<%=GetRouteUrl("userboughtnew", new { }) %>" id="ember1168" class="tabs__tab ember-view  ">Mới đặt hàng</a>
                <a href="<%=GetRouteUrl("userboughtprocessing", new { }) %>" id="ember31168" class="tabs__tab ember-view active">Đang giao</a>
