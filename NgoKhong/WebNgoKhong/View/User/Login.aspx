<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/MasterPage.master" CodeFile="Login.aspx.cs" Inherits="View_User_Login" %>
    ...
    <form runat="server" method="post">
        <div data-v-fe11aa12="" class="wrapper">
            <div data-v-fe11aa12="" class="account-container grid">
                <div data-v-fe11aa12="" class="login" style="">
                    <div data-v-44c03dd9="" data-v-fe11aa12="" class="signin-panel" style="height: auto; margin: 50px auto;">
                            ...
                            <div data-v-44c03dd9="">
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="100">
                                        ...
                                        <p id="msgPhone" runat="server" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
                                    ...
                                    <div data-v-44c03dd9="" class="grid">
                                        <p id="msgLogin" class="Shopee-input__error-msg" runat="server"></p>
                                        <div class="alert alert-success" role="alert" id="msgRegister" runat="server">Bạn đã đăng ký thành công, vui lòng đăng nhập</div>
                                    </div>
                                ...
                                <div>
                                    <p style="padding-left: 40px;">>> Nếu chưa có tài khoản, bạn vui lòng <a style="font-weight:bold" href="/register">đăng ký</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
