<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="Bought.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserBought&type=0&date=' + dateSearch,
    ...
    <div class="">
        ...
        <div class=" tab-action">
            <div class="tabs">
                <a href="<%=GetRouteUrl("userbought", new { }) %>" id="ember1144" class="tabs__tab ember-view active">Tất cả</a>
