<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="RegisterUser.aspx.cs" Inherits="View_User_Register" %>
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="16">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtSoDienThoai" type="text" placeholder="Số điện thoại (Tên Đăng Nhập)" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
