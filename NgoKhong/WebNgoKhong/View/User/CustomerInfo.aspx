<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="CustomerInfo.aspx.cs" Inherits="View_User_User" %>
        ...
        <div id="ember6145" class="shop-setting-header ember-view">
            <div class="shop-setting-header__content">
                <div style="background: #00bfa5;" class="shop-setting-header__icon">
                    <svg viewBox="0 0 1024 1024"><path d="M339.4 975.5c-8.2 0-16.4-3.1-22.6-9.4-12.5-12.5-12.5-32.8 0-45.3l405.7-405.7H224.3c-12.9 0-24.6-7.8-29.6-19.8s-2.2-25.7 6.9-34.9L604.5 57.9c12.5-12.5 32.8-12.5 45.3 0s12.5 32.8 0 45.3l-348.2 348h498.1c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9L362 966.1c-6.2 6.3-14.4 9.4-22.6 9.4z"></path></svg>
                </div>

                <div class="shop-setting-header__caption ">
                    <div class="shop-setting-header__title">Thông tin mua hàng</div>
                    <div class="shop-setting-header__subtitle">Thông tin</div>
                </div>
                <div class="shop-setting-header__buttons">
                    <a href="<%=GetRouteUrl("usereditcustomer", new object { })%>" id="btnAddProduct" class="shopee-button shopee-button--inactive shopee-button--primary ember-view">
