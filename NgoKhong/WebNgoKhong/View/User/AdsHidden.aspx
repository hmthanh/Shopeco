<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="AdsHidden.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
    <div class="">
        ...
        <div class=" tab-action">
            <div class="tabs">
                ...
                <a href="<%=GetRouteUrl("useradsshow", new { }) %>" id="ember1168" class="tabs__tab ember-view ">Tin đăng hiển thị</a>
                <a href="<%=GetRouteUrl("useradshidden", new { }) %>" id="ember31168" class="tabs__tab ember-view active">Tin đăng hết hạn</a>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type: "GET",
                url: '../Ajax.aspx?Action=UserAds&type=2',
