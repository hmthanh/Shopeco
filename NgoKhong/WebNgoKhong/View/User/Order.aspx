<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserOrder&type=0&date=' + dateSearch,
	...
	<div class="">
		...
		<div class=" tab-action">
			<div class="tabs">
				<a href="<%=GetRouteUrl("userorder", new { }) %>" id="ember1144" class="tabs__tab ember-view active">Tất cả</a>
				...
				<a href="<%=GetRouteUrl("userordercomplete", new { }) %>" id="ember331168" class="tabs__tab ember-view">Hoàn thành</a>
		...
		<div id="editPage" class="content">
			...
			<table id="table" data-search="true" data-sort="true" data-show-columns="true" data-pagination="false" data-toggle="table" class="table table-bordered table-hover dataTable">
				<thead>
					<tr>
						<th data-field="col0" data-sortable="true"><i class="fa fa-eye"></i> &nbsp;Chi tiết</th>
				...
				<tbody id="tableContent" runat="server"></tbody>
			</table>
		</div>
	</div>
</asp:Content>
