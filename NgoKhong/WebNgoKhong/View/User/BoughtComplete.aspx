<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="BoughtComplete.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserBought&type=3&date=' + dateSearch,
    ...
    <div class="">
        ...
        <div class=" tab-action">
            <div class="tabs">
                ...
                <a href="<%=GetRouteUrl("userboughtcomplete", new { }) %>" id="ember331168" class="tabs__tab ember-view active">Hoàn thành</a>
