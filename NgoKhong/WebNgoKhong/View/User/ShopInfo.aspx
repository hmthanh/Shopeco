<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="ShopInfo.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
    <div class="">
        <div id="ember6145" class="shop-setting-header ember-view">
            <div class="shop-setting-header__content">
                ...
                <div class="shop-setting-header__caption ">
                    ...
                    <div class="shop-setting-header__subtitle">Thông tin gian hàng</div>
                </div>
                <div class="shop-setting-header__buttons">
                    <a href="<%=GetRouteUrl("usershopedit", new object { })%>" id="btnAddProduct" class="shopee-button shopee-button--inactive shopee-button--primary ember-view">
                        <svg viewBox="0 0 32 32">
        ...
        <div id="ember6146" class="setting-card__row setting-card__row--disabled ember-view">
            ...
            <div id="txtTenGianHang" class="setting-card__subtitle" runat="server"></div>
        </div>
        ...
        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
            ...
            <div id="txtChuGianHang" class="setting-card__subtitle" runat="server"></div>
        </div>
        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
            <div class="setting-card__icon">
                <svg viewBox="0 0 32 32">
        ...
        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
            ...
            <div id="txtSoDienThoai" class="setting-card__subtitle" runat="server"></div>
        </div>
    </div>
</asp:Content>