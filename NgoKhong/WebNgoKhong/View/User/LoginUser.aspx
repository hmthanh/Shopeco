<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/MasterPage.master" CodeFile="LoginUser.aspx.cs" Inherits="View_User_Login" %>
                                ...
                                <div data-v-44c03dd9="" class="signin-form">
                                    ...
                                    <div data-v-44c03dd9="" class="Shopee-input" max-length="100">
                                        <div class="Shopee-input__inner Shopee-input__inner--normal">
                                            ...
                                            <input id="txtTenDangNhap" type="text" placeholder="Tên đăng nhập (Số Điện Thoại)" resize="vertical" rows="2" minrows="2" class="Shopee-input__input" runat="server">
                                            <!---->
                                        </div>
                                        <p id="msgTenDangNhap" runat="server" class="Shopee-input__error-msg" runat="server">*</p>
                                        <!---->
                                    </div>
