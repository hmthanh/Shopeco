...
public partial class View_User_Login : System.Web.UI.Page
{
    ...
    protected void btDangNhap_Click(object sender, EventArgs e)
    {
        ...
        ////////////////////////////////////////////////////////////////
        string sql = "select * from tb_User u where u.PhoneNumber='" + TenDangNhap + "'";
        ...
        sql = "select * from tb_User u where u.PhoneNumber='" + TenDangNhap + "' and u.Password = '" + StaticData.ValidParameter(MatKhau) + "'";
        ...
        if (tbCheckPassword.Rows.Count > 0)
        {
            string idGianHang = tbCheckPassword.Rows[0]["ID"].ToString();
            HttpCookie cookie = new HttpCookie("Web");
            Session["CurrentUser"] = idGianHang;
            cookie["CurrentUser"] = idGianHang;
            ...
            else
            {
                ...
                Response.Redirect("/dangnhap/dashboard");
            }
        }
    }
}