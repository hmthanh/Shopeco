<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="OrderNew.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserOrder&type=1&date=' + dateSearch,
	...
	<div class="">
		...
		<div class=" tab-action">
			<div class="tabs">
                ...
                <a href="<%=GetRouteUrl("userordernew", new { }) %>" id="ember1168" class="tabs__tab ember-view active">Mới đặt hàng</a>
