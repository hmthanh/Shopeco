<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="UserInfo.aspx.cs" Inherits="View_User_User" %>
    ...
    <div class="">
        <div id="ember6145" class="shop-setting-header ember-view">
            <div class="shop-setting-header__content">
                <div style="background: #8d9a99;" class="shop-setting-header__icon">
                ...
                <div class="shop-setting-header__caption ">
                    ...
                    <div class="shop-setting-header__subtitle">Thông tin cá nhân</div>
                </div>
                <div class="shop-setting-header__buttons">
                    <%--<a href="<%=GetRouteUrl("useredit", new object { })%>" id="btnAddProduct" class="shopee-button shopee-button--inactive shopee-button--primary ember-view">
                        <svg viewBox="0 0 32 32">
        ...
        <div id="ember6146" class="setting-card__row setting-card__row--disabled ember-view">
            ...
            <div class="setting-card__title">Mã tài khoản</div>
            <div id="txtUserID" class="setting-card__subtitle" runat="server"></div>
        </div>
        <div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
            ...
            <div class="setting-card__title">Username</div>
            <div id="txtUsername" class="setting-card__subtitle" runat="server"></div>
        </div>
        <%--<div id="ember6148" class="setting-card__row setting-card__row--disabled ember-view">
            <div class="setting-card__icon">
                <svg viewBox="0 0 32 32">
