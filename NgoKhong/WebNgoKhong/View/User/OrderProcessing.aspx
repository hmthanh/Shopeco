<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="OrderProcessing.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
	<script>
		...
		function GetData() {
			...
			$.ajax({
				type: "GET",
				url: '../Ajax.aspx?Action=UserOrder&type=2&date=' + dateSearch,
	...
	<div class="">
		...
		<div class=" tab-action">
			<div class="tabs">
                ...
                <a href="<%=GetRouteUrl("userorderprocessing", new { }) %>" id="ember31168" class="tabs__tab ember-view active">Đang giao</a>
