...
public partial class View_User_User : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string id = Session["CurrentUser"].ToString();
        string shopCode = "GH" + StaticData.getField("tb_User", "PhoneNumber", "ID", id);
        string sqlUpdateUser = "update tb_User set ShopCode = '" + shopCode + "' where ID = '" + id + "'";
        string sql = "insert into tb_GianHang(TenGianHang, DiaChi, ChuGianHang, Email, SoDienThoai, ShopCode) values(N'" + tenGianHang + "', N'" + diaChi + "', N'" + chuGianHang + "', '" + email + "', '" + phone + "', '" + shopCode + "')";
