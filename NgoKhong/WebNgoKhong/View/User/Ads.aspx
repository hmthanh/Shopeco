<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/UserMaster.master" AutoEventWireup="true" CodeFile="Ads.aspx.cs" Inherits="View_User_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMasterpageUser" runat="Server">
    <div class="">
        ...
        <div class=" tab-action">
            <div class="tabs">
                <a href="<%=GetRouteUrl("userads", new { }) %>" id="ember1144" class="tabs__tab ember-view active">Tất cả</a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type: "GET",
                url: '../Ajax.aspx?Action=UserAds&type=0',
