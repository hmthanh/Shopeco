...
public class MyStaticData
{
    ...
    public static string LinkAnh(string link)
    {
        ...
        return StaticData.validImage(link);
    }
                        ...
                        <div class='item-info'>
                            ...
                            <div class=''>
                                                <span class='date'>
                                                    ...
                                                    " + StaticData.ConvertMMDDYYtoDDMMYY(tb.Rows[i]["Ngay"].ToString()) + @"
                                                </span>
                                            </div>
                        </div>
</div>
                    ...
                    <div class='product-layout item-inner style1'>
                        ...
                        <div class='item-info'>
                            ...
                            <div class='content_price price'>
                                <span class='price-new product-price'>" + StaticData.FormatDouble(data.Rows[i]["GiaMoi"].ToString()) + @"</span>&nbsp;&nbsp;

                                <span class='price-old'>" + StaticData.FormatDouble(data.Rows[i]["GiaCu"].ToString()) + @"</span>&nbsp;
