<%@ Page Language="C#" MasterPageFile="~/Admin/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="ForumImage.aspx.cs" Inherits="Admin_View_TinTuc_LoaiTinTuc" %>
        ...
        $(document).ready(function () {
            function DeleteBanner(idBanner) {
                if (confirm("Bạn có muốn xóa không ?")) {
                    $.ajax({
                        type: "POST",
                        url: "/Admin/View/RaoVat/HinhAnhRaoVat.aspx/DeleteBrands",
                ...
                <div class="col-sm-9">
                 ...
                 <div class="col-sm-3">
                        <div style="text-align:right;">
                            ...
                            <a class="btn btn-primary" href="<%=GetRouteUrl("adminslideupdate", new { id=0}) %>"><i class="glyphicon glyphicon-plus"></i> Thêm</a>
                        </div>
                    </div>
                </div>
                </div>
            <div id="dvDanhSachLoaiTinTuc" runat="server"></div>
        </div>
        </div>
    </section>
    <!-- /.content -->
