<%@ Page Language="C#" MasterPageFile="~/Admin/Layout/MasterPage.master" validateRequest="false" AutoEventWireup="true" CodeFile="ForumEditImage.aspx.cs" Inherits="Admin_View_TinTuc_LoaiTinTin_CapNhat" %>
        ...
        <div class="box-body">
            <div class="form-horizontal" runat="server">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-10">
                        <input id="txtUrl" placeholder="Nhập số thứ tự..." class="form-control" runat="server" type="text" />
