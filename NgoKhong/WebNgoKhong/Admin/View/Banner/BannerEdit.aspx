<%@ Page Language="C#" MasterPageFile="~/Admin/Layout/MasterPage.master" validateRequest="false" AutoEventWireup="true" CodeFile="BannerEdit.aspx.cs" Inherits="Admin_View_TinTuc_LoaiTinTin_CapNhat" %>
    ...
    <div class="box">
        <div class="box-body">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-10">
                        <input id="txtUrl" placeholder="Nhập tên tiêu đề banner..." class="form-control" runat="server" type="text" />
                        <span id="msgUrl" runat="server" class="validationMessage" style="display: none"></span>
                    </div>
                </div>
                <div class="col-md-12 form-group">
                    <div class="col-md-2">
