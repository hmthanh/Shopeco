<%@ Page Language="C#" MasterPageFile="~/Admin/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="EditShop.aspx.cs" Inherits="Admin_View_SanPham_LoaiSanPham" %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="">
                            <div class="ptieude">Chỉnh sửa thông tin gian hàng</div>
                        </div>
                        <%--<div class="row">
                            ...
                            <table class="table table-bordered table-hover dataTable">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <input type="text" class="form-control" id="txtOwner" placeholder="Chủ gian hàng" runat="server"/>
                                                <div class="invalid-feedback " id="msgOwner" runat="server">
                                                    Chủ gian hàng không hợp lệ
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <input type="text" class="form-control" id="txtDesc" placeholder="Mô tả" runat="server"/>
                                                <div class="invalid-feedback " id="msgDesc" runat="server">
                                                    Mô tả không hợp lệ
                                                </div>
                                            </div>
                                        </td>
