<%@ Page Language="C#" MasterPageFile="~/Admin/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerEditInfo.aspx.cs" Inherits="Admin_View_SanPham_LoaiSanPham" %>
	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="box">
				<div class="box-body">
					<div class="">
						<div class="ptieude">Thông tin khách hàng</div>
					</div>
					<%--<div class="row">
